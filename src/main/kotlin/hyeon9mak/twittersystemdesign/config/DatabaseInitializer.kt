...
class DatabaseInitializer(
    ...
    private fun initObama() {
        ...
        for (i: Long in 1L..10_000L) {
            followRepository.save(Follow(followerId = i, followeeId = 10_001L))
        }
    }
    ...
    private fun initUserA() {
        ...
        for (i: Long in 1L..10_001L) {
            followRepository.save(Follow(followerId = 10_002L, followeeId = i))
        }
    }

    private fun initUserB() {
        userService.registerUser(id = 10_003L, username = "userB", profilePic = "userB.png")
        followRepository.save(Follow(followerId = 10_003L, followeeId = 1L))
        followRepository.save(Follow(followerId = 10_003L, followeeId = 10_001L))
    }
